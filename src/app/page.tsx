				...
				{session?.user ? (
					<div className='flex flex-col items-center gap-4 w-full'>
						...
						>
							<button
								type='submit'
								className='w-full px-4 py-2 bg-destructive text-destructive-foreground font-medium rounded-md hover:bg-destructive/90 transition-colors'
							>
								Sign Out
							</button>
						</form>
					...
					<div className='flex flex-col items-center gap-4 w-full'>
						...
						>
							<button
								type='submit'
								className='w-full px-4 py-2 bg-primary text-primary-foreground font-medium rounded-md hover:bg-primary/90 transition-colors flex items-center justify-center gap-2'
							>
