...
export function EducationForm({initialData, onClose}: {initialData?: Education; onClose?: () => void}) {
						...
						<FormField
							...
							render={({field}) => (
								<FormItem>
									...
									<FormControl>
										<Input
											placeholder='e.g. Warsaw University of Technology or Coursera'
											{...field}
											value={field.value || ''}
										/>
									</FormControl>
							...
							<FormField
								...
								render={({field}) => (
									<FormItem>
										...
										<FormControl>
											<Input
												placeholder='e.g. Bachelor of Science or React Bootcamp'
												{...field}
												value={field.value || ''}
											/>
										</FormControl>
