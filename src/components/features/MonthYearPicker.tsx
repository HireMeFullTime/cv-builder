...
export function MonthYearPicker({value, onChange}: {value?: Date; onChange: (date: Date | undefined) => void}) {
	const selectedMonth = value ? value.getUTCMonth().toString() : '';
	const selectedYear = value ? value.getUTCFullYear().toString() : '';
