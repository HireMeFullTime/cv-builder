          ...
          return (
            <Card key={project.id}>
              ...
              <CardContent className="pb-4">
                ...
                {project.accomplishments && Array.isArray(project.accomplishments) && project.accomplishments.length > 0 && (
                  <div className="mb-4">
                ...
                <div className="flex gap-4 mt-2">
                  {project.linkUrl && (
                    <Link href={project.linkUrl} target="_blank" rel="noopener noreferrer" className="flex items-center text-sm text-primary hover:underline">
                      <LinkIcon className="w-4 h-4 mr-1" /> Live Preview
                    </Link>
                  )}
                  {project.githubUrl && (
                    <Link href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="flex items-center text-sm text-primary hover:underline">
