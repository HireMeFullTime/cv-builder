...
6. **Directory Structure & File Placement (Strictly inside `src/`):**
   ...
   - `src/types/` - dedicated directory for TypeScript types and interfaces. Use this to export types inferred from Zod schemas (`z.infer<typeof schema>`) or external API definitions.
